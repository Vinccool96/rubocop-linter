...
function execute() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        (0, io_1.debug)(`git diff ${currentCommit}~ ${currentCommit} --name-only`, "command");
        const diff = yield (0, util_1.promisifyExec)(`git diff ${currentCommit}~ ${currentCommit} --name-only`)
            .then((re) => re);
        (0, io_1.debug)(diff);
